...
#define ENABLE_REG        0xA0
#define ENABLE_VALUE      0x03
#define CDATA_REG         0xB4
...
int main() {
    ...
    ioctl(fd, I2C_SLAVE, MPU6000_ADDR);
    unsigned char wake[2] = {PWR_MGMT_1, 0x00};
    write(fd, wake, 2);
    usleep(200000);

    ioctl(fd, I2C_SLAVE, COLOR_SENSOR_ADDR);
    unsigned char enable_cmd[2] = {ENABLE_REG, ENABLE_VALUE};
    write(fd, enable_cmd, 2);
    usleep(700000);
